...
(2) performing \emph{tag selection} on those decisions to mark several cells as excluded (\unchecked), and 
(3) collect all remaining cells into variants and map corresponding decisions to those variants.
